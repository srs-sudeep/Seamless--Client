...
export default function ProfilePage() {
  ...
  return (
    <div
      className={`min-h-screen transition-all duration-700 ${isDark ? 'bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900' : 'bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50'}`}
    >
      <div className="container mx-auto px-4 py-12">
        {/* Main Profile Card */}
        <div
          className={`relative overflow-hidden rounded-3xl shadow-2xl backdrop-blur-xl transition-all duration-700 transform ${
            isDark
              ? 'bg-gray-800/80 border border-gray-700/50 shadow-purple-500/10'
              : 'bg-white/80 border border-white/50 shadow-blue-500/10'
          }`}
        >
          ...
          <div className="relative z-10 p-8 md:p-12">
            ...
            <div className="flex flex-col items-center mb-16">
              ...
              <div className="text-center">
                ...
                <div
                  className={`inline-flex items-center px-6 py-2 rounded-full text-sm font-semibold tracking-wider transition-all duration-700 ${
                    isDark
